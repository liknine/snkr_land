(() => {
  ...
  // Main admin seen in the project order data + previous fallback.
  ...
  function getDisplayProductId(product, productIndex) {
    ...
    // Current products.json uses long technical IDs, while the bot admin edits by short list number.
  ...
  window.SNKR_ADMIN_ID_AND_DETAIL_PHOTO_V124 = { version: VERSION, schedule };
})();
