(() => {
  ...
  const STORAGE_KEY = "snkr_catalog_section_v98";
  ...
  if (typeof window.fetch === "function" && !window.__snkrSideSectionsFetchPatchedV98) {
    window.__snkrSideSectionsFetchPatchedV98 = true;
  ...
  function interceptSideMenuFilterClicks() {
    if (document.__snkrSideMenuFilterClicksV98) return;
    document.__snkrSideMenuFilterClicksV98 = true;
  ...
  function interceptBottomCatalogReset() {
    if (document.__snkrBottomCatalogResetV98) return;
    document.__snkrBottomCatalogResetV98 = true;
    document.addEventListener("click", (event) => {
